...
INSERT INTO t_inquiry (
    inquiry_id, user_id, household_id, category, status, title,
    create_user_id, create_program, created_at,
    update_user_id, update_program, updated_at
) VALUES
-- ステータス: 00(Open)
(101, 10, 1, '10', '00', 'アプリの使い方がわかりません',                      10, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  1 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  1 HOUR),
(102, 11, 1, '30', '00', 'パスワードを変更したい',                             11, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  2 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  2 HOUR),
(103, 12, 2, '20', '00', '定期家事が生成されない',                             12, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  5 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  5 HOUR),
(104, 13, 2, '21', '00', '買い物リストにアイテムを追加できない',               13, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  3 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  3 HOUR),
(105, 14, 2, '40', '00', 'ログインできなくなった',                             14, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  7 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  7 HOUR),
(106, 15, 2, '90', '00', 'プッシュ通知の設定方法を教えてください',             15, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  4 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  4 HOUR),
(107, 16, 2, '30', '00', 'メールアドレスを変更したい',                         16, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  2 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  2 HOUR),

-- ステータス: 10(AI Answered)
(108, 10, 1, '20', '10', '家事テンプレートの削除方法が知りたい',               10, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  3 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  8 HOUR),
(109, 11, 1, '21', '10', '購入済みアイテムを元に戻したい',                     11, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  6 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  3 HOUR),
(110, 12, 2, '30', '10', 'Googleアカウントとの連携方法',                       12, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  1 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  6 HOUR),
(111, 13, 2, '10', '10', 'おうちのメンバーにオーナー権限を渡したい',           13, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  8 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  2 HOUR),
(112, 14, 2, '40', '10', 'アプリが起動しない',                                 14, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  9 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  4 HOUR),
(113, 15, 2, '90', '10', '多言語対応の言語を追加してほしい',                   15, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  2 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  7 HOUR),
(114, 16, 2, '20', '10', '毎月の家事が二重登録されている',                     16, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  5 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  1 HOUR),
(115, 10, 1, '21', '10', 'お気に入りアイテムの使い方',                         10, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  3 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  6 HOUR),

-- ステータス: 20(Pending Staff)
(116, 11, 1, '30', '20', 'アカウントを削除したいが操作方法がわからない',       11, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  4 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  3 HOUR),
(117, 12, 2, '40', '20', '家事タスクが完了にならない不具合',                   12, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  7 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  5 HOUR),
(118, 13, 2, '10', '20', '世帯を複数管理するコツを教えてほしい',               13, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  9 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  2 HOUR),
(119, 14, 2, '21', '20', '買い物リストの並び順を変えたい',                     14, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  2 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  8 HOUR),
(120, 15, 2, '90', '20', 'ダークモードに対応してほしい',                       15, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  6 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL  6 DAY + INTERVAL  4 HOUR),
(121, 16, 2, '30', '20', 'ニックネームの変更方法',                             16, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  1 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  5 DAY + INTERVAL  7 HOUR),
(122, 10, 1, '20', '20', '定期家事の終了日を変更したい',                       10, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  4 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  4 DAY + INTERVAL  2 HOUR),
(123, 11, 1, '40', '20', '通知が届かない',                                     11, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  8 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL  3 DAY + INTERVAL  6 HOUR),
(124, 12, 2, '10', '20', 'おうちから離脱する方法',                             12, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  3 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL  2 DAY + INTERVAL  4 HOUR),
(125, 13, 2, '21', '20', '購入場所を設定したい',                               13, 'SEED_DATA', NOW(6) - INTERVAL  6 DAY + INTERVAL  5 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL  1 DAY + INTERVAL  3 HOUR),

-- ステータス: 25(Staff Answered)
(126, 14, 2, '30', '25', 'パスワードリセットメールが届かない',                 14, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  2 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  5 HOUR),
(127, 15, 2, '20', '25', '家事タスクのスキップ機能について',                   15, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  4 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  3 HOUR),
(128, 16, 2, '40', '25', '画像添付ができない',                                 16, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  6 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  7 HOUR),
(129, 10, 1, '90', '25', 'カレンダー連携機能がほしい',                         10, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  3 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  6 DAY + INTERVAL  2 HOUR),
(130, 11, 1, '10', '25', 'メンバーの招待リンクが無効になった',                 11, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  7 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL  5 DAY + INTERVAL  4 HOUR),
(131, 12, 2, '21', '25', '買い物アイテムに画像を追加したい',                   12, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  5 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL  4 DAY + INTERVAL  6 HOUR),

-- ステータス: 90(Closed)
(132, 13, 2, '30', '90', 'ログイン時のエラーメッセージの意味',                 13, 'SEED_DATA', NOW(6) - INTERVAL 15 DAY + INTERVAL  6 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  3 HOUR),
(133, 14, 2, '20', '90', '第3週の木曜日に設定する方法',                        14, 'SEED_DATA', NOW(6) - INTERVAL 14 DAY + INTERVAL  8 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  5 HOUR),
(134, 15, 2, '21', '90', '買い物リストを世帯メンバーと共有できている？',       15, 'SEED_DATA', NOW(6) - INTERVAL 13 DAY + INTERVAL  2 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  7 HOUR),
(135, 16, 2, '40', '90', '保存ボタンを押すと500エラーになる',                  16, 'SEED_DATA', NOW(6) - INTERVAL 12 DAY + INTERVAL  5 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  4 HOUR),
(136, 10, 1, '30', '90', '言語設定を英語にしたい',                             10, 'SEED_DATA', NOW(6) - INTERVAL 11 DAY + INTERVAL  1 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  8 HOUR),
(137, 11, 1, '10', '90', '同一世帯に同じ家事が重複している',                   11, 'SEED_DATA', NOW(6) - INTERVAL 10 DAY + INTERVAL  7 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  2 HOUR),
(138, 12, 2, '90', '90', 'タスクの一括完了機能がほしい',                       12, 'SEED_DATA', NOW(6) - INTERVAL  9 DAY + INTERVAL  3 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL  6 DAY + INTERVAL  6 HOUR),
(139, 13, 2, '21', '90', 'スーパー以外の購入場所を追加できますか',             13, 'SEED_DATA', NOW(6) - INTERVAL  8 DAY + INTERVAL  6 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL  5 DAY + INTERVAL  1 HOUR),
(140, 14, 2, '30', '90', 'SNS連携はできますか',                                14, 'SEED_DATA', NOW(6) - INTERVAL  7 DAY + INTERVAL  4 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL  4 DAY + INTERVAL  5 HOUR),
(141, 15, 2, '40', '90', '操作中にアプリが落ちた',                             15, 'SEED_DATA', NOW(6) - INTERVAL  6 DAY + INTERVAL  2 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL  3 DAY + INTERVAL  3 HOUR),
(142, 16, 2, '20', '90', '家事の担当者をランダムに割り当てたい',               16, 'SEED_DATA', NOW(6) - INTERVAL  5 DAY + INTERVAL  8 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  2 DAY + INTERVAL  7 HOUR),
(143, 10, 1, '21', '90', 'お気に入りアイテムを削除したい',                     10, 'SEED_DATA', NOW(6) - INTERVAL  4 DAY + INTERVAL  3 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  1 DAY + INTERVAL  2 HOUR),
(144, 11, 1, '10', '90', 'メンバーが5人以上いる世帯は作れますか',              11, 'SEED_DATA', NOW(6) - INTERVAL  3 DAY + INTERVAL  5 HOUR, 11, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL 10 HOUR),
(145, 12, 2, '30', '90', '退会後のデータはどうなりますか',                     12, 'SEED_DATA', NOW(6) - INTERVAL  2 DAY + INTERVAL  1 HOUR, 12, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  8 HOUR),
(146, 13, 2, '90', '90', 'レシピ管理機能がほしい',                             13, 'SEED_DATA', NOW(6) - INTERVAL  2 DAY + INTERVAL  6 HOUR, 13, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  6 HOUR),
(147, 14, 2, '21', '90', '買い物リストのアイテム数上限はありますか',           14, 'SEED_DATA', NOW(6) - INTERVAL  1 DAY + INTERVAL  2 HOUR, 14, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  4 HOUR),
(148, 15, 2, '40', '90', 'ソート順がおかしい',                                 15, 'SEED_DATA', NOW(6) - INTERVAL  1 DAY + INTERVAL  7 HOUR, 15, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  2 HOUR),
(149, 16, 2, '20', '90', '担当者未割当の家事を一覧で見たい',                   16, 'SEED_DATA', NOW(6) - INTERVAL  1 DAY + INTERVAL  9 HOUR, 16, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  1 HOUR),
(150, 10, 1, '30', '90', 'プロフィール画像の推奨サイズは？',                   10, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  5 HOUR, 10, 'SEED_DATA', NOW(6) - INTERVAL  0 DAY - INTERVAL  5 HOUR);
